...
export interface Shot { id: string; project_id: string; sequence: number; title: string; prompt: string; dialogue: string; duration_seconds: number; engine: string; status: string; output_url?: string; reference_url?: string; audio_url?: string }
